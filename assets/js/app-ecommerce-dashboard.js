...
!function () {
    ...
    var i = document.querySelector("#visitsRadialChart"),
        ...
        i = (
            ...
            document.querySelector("#revenueGrowthChart")
        ),
        l = {
            chart: {
                height: 90,
            ...
            colors: [
                config.colors.info, config.colors_label.secondary
            ],
            series: [
                {
                    name: "2020",
        ...
        i = (
            null !== i && new ApexCharts(i, l).render(),
            document.querySelector("#marketingCampaignChart1")
        ),
        l = {
            chart: {
                height: 55,
            ...
            colors: [
                config.colors.primary, config.colors.warning, config.colors.success
            ],
            plotOptions: {
                pie: {
                    donut: {
        ...
        i = (
            null !== i && new ApexCharts(i, l).render(),
            document.querySelector("#marketingCampaignChart2")
        ),
        l = {
            chart: {
                height: 55,
            ...
            colors: [
                config.colors.danger, config.colors.secondary, config.colors.primary
            ],
            plotOptions: {
                pie: {
                    donut: {
