...
<div class="login-box">
  <div class="login-logo">
    <center><img src="https://dc.miftahulkhoer.org/assets/logo.png" width="100px"></center>
    <a style="font-size: 18px; font-weight: bolder;" href="<?php echo url('/') ?>">MIFTAHUL KHOER DATA CENTER</a>
  </div>
  ...
  <div class="card" style="background-color: transparent !important">
    <div class="card-body login-card-body" style="background-color:#ffffff52 !important">
      <div>
      ...
      <div class="row">
        ...
        <div class="col-12">
          <button type="submit" class="btn btn-default btn-block btn-flat" onclick="javascript:document.getElementById('page-loader').style.display='block';"><?php echo lang('signin') ?></button>
        </div>
      </div>
    <?php echo form_close(); ?>
