        ...
        <div class="col-lg-12">
            <div class="card basic-data-table">
                <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3 bg-success" >
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        <a href="<?php echo url('sarpras/alatTambah') ?>" class="btn btn-sm btn-success-100 text-success"><i class="ri-add-line"></i> Tambah PTK</a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table bordered-table mb-0" id="dataTable" data-page-length='10'>
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Nama PTK Nonaktif</th>
                                    <th scope="col">NIK</th>
                                    <th scope="col">NIY</th>
