    ...
    <div class="sidebar-menu-area">
        <ul class="sidebar-menu" id="sidebar-menu">
            ...
            <?php if ($is_guru_portal): ?>
                ...
                <!-- Menu Baru Yang Diizinkan Akses Oleh Guru -->
                <li class="sidebar-menu-group-title" style="background: #d3c5b1; background: linear-gradient(90deg, rgb(255, 233, 135) 0%, rgba(255, 255, 255, 0) 100%);">Pembelajaran & Jadwal</li>
                
                <?php if (hasPermissions('menu_jadwal_pelajaran') || hasPermissions('menu_jadwal_tidak_aktif') || $is_guru_portal): ?>
                    <li class="dropdown">
                ...
                <li class="sidebar-menu-group-title" style="background: #bdd3b1; background: linear-gradient(90deg, rgb(232, 191, 255) 0%, rgba(255, 255, 255, 0) 100%);">Pencetakan & Surat</li>
                ...
                <li class="sidebar-menu-group-title" style="background: #bdd3b1; background: linear-gradient(90deg, rgb(253, 200, 200) 0%, rgba(255, 255, 255, 0) 100%);">Kesiswaan & Alumni</li>
