        ...
        <div class="col-lg-12">
            <div class="card basic-data-table">
                <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3 bg-neutral-300">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        <a href="<?php echo url('tahun_pelajaran/add') ?>" class="btn btn-sm btn-primary-600"><i class="ri-add-line"></i> Tambah</a>
                    </div>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex align-items-center gap-10 justify-content-center">
                                                ...
                                                <?php endif; ?>
                                                <a href="<?php echo url('tahun_pelajaran/edit/' . $row->id_tahun_pelajaran) ?>" class="bg-success-100 text-success-600 bg-hover-success-200 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle" title="Edit">
                                                    <iconify-icon icon="lucide:edit" class="menu-icon"></iconify-icon>
                                                </a>
                                                <a href="<?php echo url('tahun_pelajaran/delete/' . $row->id_tahun_pelajaran) ?>" class="bg-danger-100 text-danger-600 bg-hover-danger-200 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle" onclick="return confirm('Hapus data ini?')" title="Hapus">
