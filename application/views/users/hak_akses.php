        ...
        <div class="col-lg-12">
            ...
            <div class="card mb-24">
                <div class="card-header bg-primary-600 d-flex align-items-center gap-3">
                    ...
                    <h6 class="text-white mb-0">Hak Akses Individual — <?php echo htmlspecialchars($user_data->name) ?></h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <table class="table table-borderless table-sm mb-0">
                                <tr>
                                    <td class="text-muted fw-semibold" style="width: 140px;">Nama</td>
                                    <td style="width: 10px;">:</td>
                                    <td class="fw-bold"><?php echo htmlspecialchars($user_data->name) ?></td>
                                </tr>
                                <tr>
                                ...
                                <?php if ($ptk_data): ?>
                                <tr>
                                    <td class="text-muted fw-semibold">PTK Terkait</td>
                                    <td>:</td>
                                    <td><?php echo htmlspecialchars($ptk_data->nama_ptk) ?> (<?php echo $ptk_data->niy ?: ($ptk_data->nip ?: '-') ?>)</td>
                                </tr>
                                <?php endif; ?>
                            </table>
                        </div>
                        <div class="col-md-6">
                            <table class="table table-borderless table-sm mb-0">
                                <tr>
                                    <td class="text-muted fw-semibold" style="width: 140px;">Role Utama</td>
                                    <td style="width: 10px;">:</td>
                                    <td>
            ...
            <div class="card">
                <div class="card-header bg-base d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        <a href="<?php echo url('users') ?>" class="btn btn-sm btn-outline-secondary radius-6 px-12 py-6">
                            <i class="ri-arrow-left-line"></i> Kembali
                        </a>
                    </div>
                </div>

                <?php echo form_open('users/save_hak_akses/' . $user_data->id, ['class' => 'form-validate']); ?>
                <div class="card-body">
                    ...
                    <div class="alert alert-info-600 d-flex align-items-start gap-2 mb-24 py-10 px-16 radius-8" style="background: #eff6ff; border: 1px solid #bfdbfe;">
                        ...
                        <div class="text-sm text-neutral-800">
                            ...
                            <br>Centang permission tambahan yang ingin diberikan secara khusus untuk user ini.
                        </div>
                    </div>
                ...
                <div class="card-footer d-flex justify-content-between">
                    <a href="<?php echo url('users') ?>" onclick="return confirm('Yakin ingin kembali? Perubahan yang belum disimpan akan hilang.')" class="btn btn-outline-danger radius-6 px-16">
