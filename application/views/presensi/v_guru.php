        ...
        <div class="col-lg-12">
            ...
            <ul class="nav nav-tabs mb-20" id="presensiTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link <?php echo !$this->input->get('bulan_tahun') ? 'active' : '' ?>"
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link <?php echo $this->input->get('bulan_tahun') ? 'active' : '' ?>"
                        ...
                        <iconify-icon icon="icon-park-outline:user-business" class="me-1"></iconify-icon> Rekap Bulanan (Grid Guru & Staf)
                    </button>
                </li>
            </ul>
            ...
            <div class="tab-content" id="presensiTabContent">
                ...
                <!-- ======================== TAB 1: HARI INI ======================== -->
                <div class="tab-pane fade <?php echo !$this->input->get('bulan_tahun') ? 'show active' : '' ?>"
                    ...
                    <div class="card basic-data-table">
                        <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3 bg-info-600">
                            <h6 class="text-light mb-0">
                                Kehadiran Guru & Staf — <?php echo date('d-m-Y', strtotime($tanggal)) ?>
                            </h6>
                            <form method="get" action="<?php echo url('presensi/guru') ?>" class="d-flex align-items-center gap-2">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table bordered-table mb-0" id="presensiGuruTable">
                                    <thead>
                                        <tr>
                                        ...
                                        <?php if (!empty($presensi_harian)): ?>
                                            <?php foreach ($presensi_harian as $p): ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo html_escape($p->nama_ptk) ?></td>
                                                    <td><?php echo html_escape($p->penugasan ?: '-') ?></td>
                        ...
                        <div class="card-body">
                                    ...
                                    <table>
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="sticky-col-2">Nama Guru / Staf</th>
                                            ...
                                            <?php foreach ($guru_list as $g): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php foreach ($tanggal_list as $t):
                                                        ...
                                                        $po  = isset($presensi_matrix[$g->id_ptk][$tgl]) ? $presensi_matrix[$g->id_ptk][$tgl] : null;
                            ...
                            <?php else: ?>
                                <div class="text-center py-40 text-secondary-light">
                                    ...
                                    <p class="text-sm">Pilih Bulan Presensi untuk menampilkan rekap kehadiran Guru & Staf.</p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
